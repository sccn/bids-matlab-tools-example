...
stimtype = { 'condition 2'  fullfile('stimuli','500Hz_50_76dbSPL_minus8db.wav');
             'condition 4'  fullfile('stimuli','1000Hz_50_76dbSPL_minus20db.wav');
             'condition 8'  fullfile('stimuli','WN_-5dB_76dbSPL_minus23db.wav') };
